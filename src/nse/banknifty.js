...
//       .then((res) => res.json())
//       .then((json) => {
//         console.log("LocalData", json.data);
//       })
...
//   const buys = [];
//   // console.log(pemax !== cemax && diffrent >= 5000 && pcr >= 0.7);

//   pemax.map((ab) => {
//     if (pemax !== cemax && diffrent >= 5000 && pcr >= 0.7) {
...
//     console.log("setting_id", buy_stutas, setting_id);
